...
@if (count($categories) > 0)
  {!! Form::open(['route' => 'post.store', 'method' => 'POST', 'enctype' => 'multipart/form-data', 'class' => 'py-3']) !!}
    @csrf
  <div class="row">
    ...
    <div class="col-lg-9 col-md-12">
      <div class="card card-small mb-3">
        <div class="card-body">
            {!! Form::select('category', $post_categories, '', ['class' => 'form-control my-4']) !!}
            {!! Form::text('post_title', '', ['class' => 'form-control mb-4', 'placeholder' => 'Post Title', 'required']) !!}
            {!! Form::select('type', [0 => 'Latest', 1 => 'Featured', 2 => 'Breaking'], 0, ['class' => 'form-control mb-4']) !!}
            <div class="mb-4">
              {!! Form::text('tags', '', ['class' => 'form-control form-control-lg mb-4', 'placeholder' => 'Tags', 'required']) !!}
            </div>
            {!! Form::textarea('description', '', ['required', 'id' => 'description', 'class' => 'add-new-post__editor mb-1']) !!}
        </div>
      </div>
    </div>
    <!-- / Add New Post Form -->
...
@else
    <p>Create Category To Add Post</p>
@endif
